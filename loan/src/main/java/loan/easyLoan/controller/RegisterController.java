...
public class RegisterController {
    ...
    public String subRegister1(@RequestBody String phoneNumber){
    ...
    public String subRegister2(@RequestBody String phoneNumber){
        System.out.println(phoneNumber);
    ...
    public String subRegister3(@RequestBody Map obj){
        ...
        int verifyCode = (Integer) obj.get("verifyCode");
        System.out.println(phoneNumber);
    ...
    public String subRegister5(@RequestBody String bankNumber){
